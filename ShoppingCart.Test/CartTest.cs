...
namespace ShoppingCart.Test
{
    ...
    public class CartTest
    {
        ...
        {
            _cart.Add(new OrderItemUnidad() { Quantity = 1, Sku = "U124AXLAF" });
        ...
        {
            _cart.Add(new OrderItemPeso() { Quantity = 500, Sku = "P110SSLLF" });
        ...
        {
            _cart.Add(new OrderItemEspacial() { Quantity = 2, Sku = "E152AABAG" });
        ...
        {
            _cart.Add(new OrderItemEspacial() { Quantity = 6, Sku = "E152AXLLA" });
